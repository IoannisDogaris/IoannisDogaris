...
- Yield prediction using ML (RF, XGBoost)  
- DOE, RSM, and multivariate optimization  
- Hybrid mechanistic + ML modeling (in progress)
...
### **Yield Prediction Using Machine Learning** *(in progress)*  
RF/XGBoost models predicting process outcomes from historical runs.

### **DOE Optimization Case Study** *(in progress)*  
RSM‑based optimization for bioprocess parameters.

---

## 📚 What I'm Learning/Upcoming Work
...
## 📬 Contact
📧 [ioannis.dogaris@gmail.com] 
💼 [LinkedIn] [https://www.linkedin.com/in/ioannisdogaris/]
